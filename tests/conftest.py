...
from shared.common.secrets import _get_client  # pyright: ignore[reportPrivateUsage]
...
@pytest.fixture
def mock_storage_client() -> Generator[MockClientDict]:
...
@pytest.fixture
def mock_bigquery_client() -> Generator[MockClientDict]:
...
@pytest.fixture
def mock_secret_manager() -> Generator[MockClientDict]:
...
@pytest.fixture
def mock_requests() -> Generator[MockRequestsDict]:
