...
The rule for picking one vs two Functions diagrams (and the reference
templates) lives in the canonical
[Diagram Catalog](../diagrams/README.md#cloud-functions-when-to-use-1-vs-2-diagrams).
